...
def upgrade():
    ...
    op.create_table('turmas',
        ...
        sa.Column('letiva', sa.Boolean(), nullable=False),
        sa.ForeignKeyConstraint(['ano_letivo_id'], ['anos_letivos.id']),
    )
    ...
    op.create_table('calendario_aulas',
        ...
        sa.Column('tipo', sa.String(length=50), nullable=False),
        sa.Column('apagado', sa.Boolean(), nullable=False),
        ...
        sa.Column('atividade', sa.Boolean(), nullable=False),
    ...
    op.create_table('aulas_alunos',
        ...
        sa.Column('aluno_id', sa.Integer(), nullable=False),
        sa.Column('atraso', sa.Boolean(), nullable=False),
