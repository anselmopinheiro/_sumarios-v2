...
def upgrade():
    op.create_table('anos_letivos',
        ...
        sa.Column('fechado', sa.Boolean(), nullable=False, server_default=sa.text('0')),
    ...
    op.create_table('turmas',
        ...
        sa.Column('letiva', sa.Boolean(), nullable=False, server_default=sa.text('1')),
        sa.ForeignKeyConstraint(['ano_letivo_id'], ['anos_letivos.id']),
    )
    ...
    op.create_table('calendario_aulas',
        ...
        sa.Column('atividade', sa.Boolean(), nullable=False, server_default=sa.text('0')),
