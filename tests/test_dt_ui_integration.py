...
def test_dt_ui_routes_and_forms_are_navigable():
    ...
    assert result["cargo_aluno_post"] in {301, 302, 303}
    assert result["cargo_ee_post"] in {301, 302, 303}
    assert result["dt_list_summary"]
